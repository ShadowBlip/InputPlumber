...
pub struct DBusDevice {
    ...
    dbus_interfaces: HashSet<&'static str>,
...
impl TargetInputDevice for DBusDevice {
    fn start_dbus_interface(
        ...
        self.dbus_interfaces
            .insert(TargetInterface::interface_name());
        let iface = TargetDBusInterface::new();
        self.dbus_interfaces
            .insert(TargetDBusInterface::interface_name());
    ...
    fn stop_dbus_interface(&mut self, dbus: Connection, path: String) {
        ...
        tokio::task::spawn(async move {
            ...
            let ff_iface_name = ForceFeedbackInterface::<CompositeDeviceClient>::interface_name();
