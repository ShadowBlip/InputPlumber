...
use crate::{
    ...
    input::{
        capability::{self, Capability, Gamepad, GamepadAxis, GamepadButton, GamepadTrigger},
    ...
    fn update_state(&mut self, event: NativeEvent) {
        ...
        match capability {
            ...
            Capability::Touchpad(touch) => {
                match touch {
                    capability::Touchpad::RightPad(touch_event) => {
                        match touch_event {
                            capability::Touch::Motion => {
                            ...
                            capability::Touch::Button(button) => match button {
                                capability::TouchButton::Touch => (),
                                capability::TouchButton::Press => match self.state {
                                    PackedInputDataReport::Usb(ref mut state) => {
                    ...
                    capability::Touchpad::CenterPad(_) => {}

                    capability::Touchpad::LeftPad(_) => {}
                }
            }
            Capability::Mouse(_) => (),
