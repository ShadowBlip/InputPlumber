    ...
    pub fn get_device(&self) -> UdevDevice {
        match self {
            ...
            SourceDevice::HidRaw(device) => match device {
                ...
                HidRawDevice::LegionGoDA(device) => device.info(),
                HidRawDevice::LegionGoDD(device) => device.info(),
    ...
    pub fn get_device_ref(&self) -> &UdevDevice {
        match self {
            ...
            SourceDevice::HidRaw(device) => match device {
                ...
                HidRawDevice::LegionGoDA(device) => device.info_ref(),
                HidRawDevice::LegionGoDD(device) => device.info_ref(),
    ...
    pub fn get_id(&self) -> String {
        match self {
            ...
            SourceDevice::HidRaw(device) => match device {
                ...
                HidRawDevice::LegionGoDA(device) => device.get_id(),
                HidRawDevice::LegionGoDD(device) => device.get_id(),
    ...
    pub fn client(&self) -> SourceDeviceClient {
        match self {
            ...
            SourceDevice::HidRaw(device) => match device {
                ...
                HidRawDevice::LegionGoDA(device) => device.client(),
                HidRawDevice::LegionGoDD(device) => device.client(),
    ...
    pub async fn run(self) -> Result<(), Box<dyn Error>> {
        match self {
            ...
            SourceDevice::HidRaw(device) => match device {
                ...
                HidRawDevice::LegionGoDA(device) => device.run().await,
                HidRawDevice::LegionGoDD(device) => device.run().await,
    ...
    pub fn get_capabilities(&self) -> Result<Vec<Capability>, InputError> {
        match self {
            ...
            SourceDevice::HidRaw(device) => match device {
                ...
                HidRawDevice::LegionGoDA(device) => device.get_capabilities(),
                HidRawDevice::LegionGoDD(device) => device.get_capabilities(),
    ...
    pub fn get_device_path(&self) -> String {
        match self {
            ...
            SourceDevice::HidRaw(device) => match device {
                ...
                HidRawDevice::LegionGoDA(device) => device.get_device_path(),
                HidRawDevice::LegionGoDD(device) => device.get_device_path(),
