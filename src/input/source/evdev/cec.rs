...
// https://github.com/torvalds/linux/blob/master/drivers/media/rc/keymaps/rc-cec.c

/// Source device implementation for evdev gamepads
pub struct CecEventDevice {
    device: Device,
}

impl CecEventDevice {
    /// Create a new [CecEventDevice] source device from the given udev info
    pub fn new(
...
impl SourceInputDevice for CecEventDevice {
...
impl SourceOutputDevice for CecEventDevice {}

impl Debug for CecEventDevice {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("CecEventDevice").finish()
    }
}
