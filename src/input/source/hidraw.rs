...
impl HidRawDevice {
    ...
    fn get_driver_type(device: &UdevDevice, is_blocked: bool) -> DriverType {
        ...
        // Legion Go S IMU
        if vid == drivers::legos::imu_driver::VID
            && drivers::legos::imu_driver::PIDS.contains(&pid)
            && iid == drivers::legos::imu_driver::IID
        {
        ...
        if vid == drivers::legos::touchpad_driver::VID
            && drivers::legos::touchpad_driver::PIDS.contains(&pid)
            && iid == drivers::legos::touchpad_driver::IID
        {
        ...
        // Legion Go S XInput
        if vid == drivers::legos::xinput_driver::VID
            && drivers::legos::xinput_driver::PIDS.contains(&pid)
            && iid == drivers::legos::xinput_driver::IID
        {
