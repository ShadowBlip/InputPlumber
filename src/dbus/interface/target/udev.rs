...
pub struct TargetUdevDeviceInterface {
    device: UdevDevice,
}

impl TargetUdevDeviceInterface {
    pub fn new(device: UdevDevice) -> TargetUdevDeviceInterface {
        TargetUdevDeviceInterface { device }
    }
    ...
    pub async fn listen_on_dbus(
        ...
        let iface = TargetUdevDeviceInterface::new(device);
...
#[interface(
    name = "org.shadowblip.Input.Target.UdevDevice",
